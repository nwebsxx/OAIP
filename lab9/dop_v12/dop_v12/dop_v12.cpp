...
//первый - четные числа, второй - нечетные
...
void separate(Node*& original, Node*& even, Node*& odd)    //разделение на полож. и отриц.
{
...
int main()
{
    ...
    do
    {
        ...
        cout << "5. Разделить стек на 2 новых (1 - четные, 2 - нечетные числа)" << endl;
