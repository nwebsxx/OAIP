//функция возвращение истины если список пуст и ложно в противном случае
...
bool returN(List** head, List** tail)            //истина - список пуст, ложно - в списке есть элементы
{
...
int main()
{
	...
	do
	{
		...
		cout << "7. Проверка на пустоту списка" << endl;
		cout << "8. Выход" << endl;
